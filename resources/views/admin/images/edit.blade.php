...
@section('admin_content')
    <div class="fade-up max-w-4xl mx-auto">
        <div class="mb-10">
            ...
            <h2 class="text-3xl font-black italic text-white uppercase tracking-tighter">Modify<span
                    class="text-pink-600">_Asset</span></h2>
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative group aspect-video rounded-2xl overflow-hidden border border-white/10 bg-black/40 backdrop-blur-md">
                        @if ($image->media_type == 'video')
                            ...
                            @endphp
                            <video src="{{ $image->file_path }}" poster="{{ $thumbUrl }}"
                    ...
                    <input type="file" name="image"
                        class="w-full text-xs text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-[10px] file:font-black file:bg-cyan-500/10 file:text-cyan-500 hover:file:bg-cyan-500/20 transition cursor-pointer">
